...
const HomeContent = () => {
  ...
  return (
    <Fragment>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#003893] via-[#001841] to-[#001841] text-white min-h-screen flex items-center relative opacity-95 transition-opacity duration-500">
